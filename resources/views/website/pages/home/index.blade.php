            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide" lazy="true">
                    <div class="slider-effect wrap-slider">
                        ...
                        <div class="img-slider">
                            <img class="lazyload"
                                data-src="{{ asset('/') }}website/assets/images/slider/fashion-06-slide1.jpg"
                                alt="fashion-slideshow"
                                src="{{ asset('/') }}website/assets/images/slider/fashion-06-slide1.jpg"
                                alt="fashion-slideshow">
                        </div>
                    </div>
                </div>
                <div class="swiper-slide" lazy="true">
                    <div class="slider-effect wrap-slider">
                        ...
                        <div class="img-slider">
                            <img class="lazyload"
                                data-src="{{ asset('/') }}website/assets/images/slider/fashion-06-slide2.jpg"
                                src="{{ asset('/') }}website/assets/images/slider/fashion-06-slide2.jpg"
                                alt="fashion-slideshow">
                        </div>
                    </div>
                </div>
                <div class="swiper-slide" lazy="true">
                    <div class="slider-effect wrap-slider">
                        ...
                        <div class="img-slider">
                            <img class="lazyload"
                                data-src="{{ asset('/') }}website/assets/images/slider/fashion-06-slide3.jpg"
                                src="{{ asset('/') }}website/assets/images/slider/fashion-06-slide3.jpg"
                                alt="fashion-slideshow">
                        </div>
                    </div>
                </div>
                                ...
                                <div class="card-product fl-item">
                                    <div class="card-product-wrapper">
                                        <a href="{{ url('shop-section-details/' . $product->slug) }}" class="product-img">
                                            @php
                                                $defaultImage =
                                                    $product->colorImages->first()->image_path ??
                                                    'website/assets/images/products/default.jpg';
                                            @endphp
                                            <img class="lazyload img-product main-img" src="{{ asset($defaultImage) }}"
                                                alt="{{ $product->product_name }}">
                                            <img class="lazyload img-hover hover-img" src="{{ asset($defaultImage) }}"
                                                alt="{{ $product->product_name }}">
                                        </a>
                                            ...
                                            <ul class="list-color-product">
                                                @foreach ($product->colorImages as $index => $colorImage)
                                                    <li class="list-color-item color-swatch {{ $index == 0 ? 'active' : '' }}"
                                                        ...
                                                        <span
                                                            class="tooltip">{{ $colorImage->color_name ?? 'Color' }}</span>
                    ...
                    <div class="swiper-slide" lazy="true">
                        <div class="collection-item-v4 hover-img">
                            <div class="collection-inner">
                                <a href="shop-collection-sub.html" class="collection-image img-style">
                                    <img class="lazyload"
                                        data-src="{{ asset('/') }}website/assets/images/collections/collection-39.jpg"
                                        src="{{ asset('/') }}website/assets/images/collections/collection-39.jpg"
                                        alt="collection-img">
                                </a>
                    ...
                    <div class="swiper-slide" lazy="true">
                        <div class="collection-item-v4 hover-img">
                            <div class="collection-inner">
                                <a href="shop-collection-sub.html" class="collection-image img-style">
                                    <img class="lazyload"
                                        data-src="{{ asset('/') }}website/assets/images/collections/collection-40.jpg"
                                        src="{{ asset('/') }}website/assets/images/collections/collection-40.jpg"
                                        alt="collection-img">
                                </a>
                                <div class="collection-content wow fadeInUp" data-wow-delay="0s">
                                    <p class="subheading">UP TO 30% OFF</p>
                    ...
                    <div class="swiper-slide" lazy="true">
                        <div class="collection-item-v4 hover-img">
                            <div class="collection-inner">
                                <a href="shop-collection-sub.html" class="collection-image img-style">
                                    <img class="lazyload"
                                        data-src="{{ asset('/') }}website/assets/images/collections/collection-41.jpg"
                                        src="{{ asset('/') }}website/assets/images/collections/collection-41.jpg"
                                        alt="collection-img">
                                </a>
                                <div class="collection-content wow fadeInUp" data-wow-delay="0s">
                                    <p class="subheading">UP TO 30% OFF</p>
