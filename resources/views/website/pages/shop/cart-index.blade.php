                                    ...
                                    <tr class="tf-cart-item file-delete">
                                        <td class="tf-cart-item_product">
                                            <a href="{{ route('shop.details', $item['product_slug']) }}" class="img-box">
                                                <img src="{{ asset('storage/' . $item['image_path']) }}" alt="img-product">
                                            </a>
                                            <div class="cart-info">
                                                ...
                                                <span class="remove-cart link remove" data-cart-key="{{ $item['product_id'] . '-' . $item['color_id'] . '-' . $item['size_id'] }}">Remove</span>
                                            </div>
                                        </td>
                                        ...
                                        <td class="tf-cart-item_quantity" cart-data-title="Quantity">
                                            <div class="cart-quantity">
                                                <div class="wg-quantity">
                                                    ...
                                                    <input type="text" name="number" value="{{ $item['quantity'] }}" data-cart-key="{{ $item['product_id'] . '-' . $item['color_id'] . '-' . $item['size_id'] }}">
                        ...
                        <div class="tf-cart-footer-inner">
                            <div class="tf-free-shipping-bar">
                                <div class="tf-progress-bar">
                                    <span style="width: {{ min(($total / 75) * 100, 100) }}%;">
                                ...
                                <div class="tf-progress-msg">
                                    @if($total >= 75) You have <span class="fw-6">Free Shipping</span>! @else Buy <span class="price fw-6">${{ number_format(75 - $total, 2) }}</span> more to enjoy <span class="fw-6">Free Shipping</span> @endif
                                </div>
                            </div>
                            <div class="tf-page-cart-checkout">
                                ...
                                <div class="tf-cart-totals-discounts">
                                    <h3>Subtotal</h3>
                                    <span class="total-value">${{ number_format($total, 2) }} USD</span>
                                </div>
                                <p class="tf-cart-tax">
