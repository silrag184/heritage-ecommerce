<!-- Announcement Bar -->
        <div class="announcement-bar bg_dark-green">
                    ...
                    <div class="row wrapper-header align-items-center">
                            ...
                            <div class="tf-cur">
                                <div class="tf-currencies">
                                    <select class="image-select center style-default type-currencies">
                                        <option data-thumbnail="{{asset('/')}}website/assets/images/country/fr.svg">EUR € | France
                                        </option>
                                        <option data-thumbnail="{{asset('/')}}website/assets/images/country/de.svg">EUR € | Germany
                                        </option>
                                        <option selected data-thumbnail="{{asset('/')}}website/assets/images/country/us.svg">USD $ | United States
                                        </option>
                                        <option data-thumbnail="{{asset('/')}}website/assets/images/country/vn.svg">VND ₫ | Vietnam
                                        </option>
                                    </select>
                                </div>
                        ...
                        <div class="col-xl-2 col-md-4 col-6 text-center">
                            <a href="index.html" class="logo-header">
                                <img src="{{asset('/')}}website/assets/images/logo/heritage-logo.svg" alt="logo" class="logo">
                            </a>
                        </div>
                    ...
                    <div class="wrapper-header d-flex justify-content-center align-items-center">
                        <nav class="box-navigation text-center">
                            <ul class="box-nav-ul d-flex align-items-center justify-content-center gap-30">
                                ...
                                <li class="menu-item">
                                    <a href="{{ route('shop.section') }}" class="item-link">Shop</a>
                                </li>
        ...
        <div class="mb-canvas-content">
            ...
            <div class="mb-bottom">
                ...
                <div class="bottom-bar-language">
                    <div class="tf-currencies">
                        <select class="image-select center style-default type-currencies">
                            <option data-thumbnail="{{asset('/')}}website/assets/images/country/fr.svg">EUR € | France</option>
                            <option data-thumbnail="{{asset('/')}}website/assets/images/country/de.svg">EUR € | Germany</option>
                            <option selected data-thumbnail="{{asset('/')}}website/assets/images/country/us.svg">USD $ | United States</option>
                            <option data-thumbnail="{{asset('/')}}website/assets/images/country/vn.svg">VND ₫ | Vietnam</option>
                        </select>
                    </div>
                    <div class="tf-languages">
                        <select class="image-select center style-default type-languages">
