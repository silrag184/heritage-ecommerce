                            ...
                            <div class="col-xl-3 col-md-6 col-12">
                                <div class="footer-infor">
                                    <div class="footer-logo">
                                        <a href="index.html">
                                            <img src="{{asset('/')}}website/assets/images/logo/heritage-logo.svg" alt="logo" width="200" height="30">
                                        </a>
                                    </div>
                                    <ul>
                                        <li>
                                        ...
                                        <div class="tf-cur">
                                            <div class="tf-currencies">
                                                <select class="image-select center style-default type-currencies">
                                                    ...
                                                    <option selected data-thumbnail="{{asset('/')}}website/assets/images/country/us.svg">USD $ |
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div
                                    ...
                                    <div class="footer-menu_item">© 2025 NextZenCode. All Rights Reserved</div>
