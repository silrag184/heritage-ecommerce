                        ...
                        <div class="tf-col-content">
                            ...
                            <div class="tf-search-hidden-inner">
                                ...
                                <div class="tf-loop-item">
                                    <div class="image">
                                        <a href="product-detail.html">
                                            <img src="{{asset('/')}}website/assets/images/products/white-1.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="content">
                                ...
                                <div class="tf-compare-offcanvas">
                                    <div class="tf-compare-item">
                                        <div class="position-relative">
                                            ...
                                            <a href="product-detail.html">
                                                <img class="radius-3" src="{{asset('/')}}website/assets/images/products/orange-1.jpg" alt="">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="tf-compare-item">
                                        <div class="position-relative">
                                            ...
                                            <a href="product-detail.html">
                                                <img class="radius-3" src="{{asset('/')}}website/assets/images/products/pink-1.jpg" alt="">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="wrap">
                    ...
                    <div class="tf-product-info-buy-button">
                        <form class="">
                            ...
                            <div class="w-100">
                                <a href="#" class="btns-full">Buy with <img src="{{asset('/')}}website/assets/images/payments/paypal.png" alt=""></a>
                    ...
                    <div class="tf-product-media-wrap">
                        <div dir="ltr" class="swiper tf-single-slide">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="item">
                                        <img src="{{asset('/')}}website/assets/images/products/pink-1.jpg" alt="">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tf-product-info-list">
                            ...
                            <div class="tf-product-info-buy-button">
                                <form class="">
                                    ...
                                    <div class="w-100">
                                        <a href="#" class="btns-full">Buy with <img src="{{asset('/')}}website/assets/images/payments/paypal.png"
                                                alt=""></a>
                                        <a href="#" class="payment-more-option">More payment options</a>
                                    </div>
                                </form>
            ...
            <div class="modal-content">
                ...
                <div class="tf-rte">
                    ...
                    <div class="tf-page-size-chart-content">
                        ...
                        <div>
                            <img class="sizechart lazyload" data-src="{{asset('/')}}website/assets/images/shop/products/size_chart2.jpg"
                                src="{{asset('/')}}website/assets/images/shop/products/size_chart2.jpg" alt="">
                        </div>
                    </div>
                </div>
            </div>
