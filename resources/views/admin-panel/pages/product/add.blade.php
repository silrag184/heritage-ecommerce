                            ...
                            <div class="card-body p-0 create-project-main">
                                <form action="{{ route('product.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row p-5 border-bottom">
                                        ...
                                        <div class="col-sm-12 col-md-12 col-xl-3">
                                            <div class="form-group">
                                                ...
                                                <select
                                                    ...
                                                    id="" name="" data-placeholder="Choose Type..." required>
                                        ...
                                        <div class="col-sm-12 col-md-12 col-xl-3">
                                            <div class="form-group">
                                                <label for="" class="form-label text-muted"> <span
                                                        class="text-danger">*</span></label>
                                                <div class="input-group">
                                                    <input id="" type="text"
                                                        class="form-control text-dark @error('') is-invalid @enderror"
                                                        name="" value="" placeholder="Enter Client Name" required>
                                                    @error('')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-md-12 col-xl-6">
                                            <div class="form-group">
                                                ...
                                                <textarea class="summernote form-control @error('') is-invalid @enderror"
                                                    name="" id="">{{ old('') }}</textarea>
                                                @error('')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-sm-12 col-md-12 col-xl-6">
                                            <label for="thumbnail_image" class="form-label text-muted">Thumbnail Image:
                                            </label>
                                            <div class="form-group">
                                                <input type="file"
                                        ...
                                        <div class="col-sm-12 col-md-12 col-xl-6">
                                            ...
                                            <div class="form-group">
                                                <input id="other_images" type="file"
                                                    class="form-control @error('other_images') is-invalid @enderror"
                                                    name="other_images[]" accept="image/jpeg,image/png,image/jpg,image/gif"
                                                    multiple />
                                                @error('other_images')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input id="meta_title" type="text"
                                                        class="form-control text-dark @error('meta_title') is-invalid @enderror"
                                        ...
                                        <div class="col-sm-12 col-md-12 col-xl-12">
                                                        ...
                                                        <div class="row align-items-center mb-2 color-image-row">
                                                            <div class="col-md-4">
                                                                ...
                                                                <input type="color" class="form-control form-control-color"
                                                                    name="colors[]" value="#000000" title="Choose color">
                                                            </div>
                                                            <div class="col-md-4">
                                                                <label class="form-label">Image</label>
                                                                <input type="file" class="form-control"
                                                                    name="color_images[]" accept="image/*" required>
                                                            </div>
                                                            <div class="col-md-2">
                                                                <button type="button"
                                                                    class="btn btn-danger w-100 remove-row mt-4">
                                                                    <i class="fe fe-trash-2"></i> Remove
                                                                </button>
                                                            </div>
                                                            <div class="col-md-2">
                                                                <button type="button"
                                                                    class="btn btn-success w-100 add-more-row mt-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input id="tags" type="text"
                                                            class="form-control text-dark @error('tags') is-invalid @enderror"
                                            ...
                                            <div class="col-sm-12 col-md-12 col-xl-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <textarea
                                                            class="form-control content @error('meta_description') is-invalid @enderror"
                                                            id="meta_description" name="meta_description"
                                                            row="1">{{ old('meta_description') }}</textarea>
    ...
    <script>
        document.addEventListener('click', function (e) {
            ...
            if (e.target.closest('.add-more-row')) {
                let container = document.getElementById('colorImageContainer');
                let newRow = document.createElement('div');
                newRow.classList.add('row', 'align-items-center', 'mb-2', 'color-image-row');
                newRow.innerHTML = `
                <div class="col-md-4">
                    <label class="form-label">Color</label>
                    <input type="color" class="form-control form-control-color" name="colors[]" value="#000000" title="Choose color">
                </div>
                <div class="col-md-4">
                    <label class="form-label">Image</label>
                ...
                <div class="col-md-2">
                    <button type="button" class="btn btn-danger w-100 remove-row mt-4">
                        <i class="fe fe-trash-2"></i> Remove
                    </button>
                </div>
                <div class="col-md-2">
                    <button type="button" class="btn btn-success w-100 add-more-row mt-4">
                        <i class="fe fe-plus"></i> Add More
                    </button>
                </div>
            `;
            ...
            if (e.target.closest('.remove-row')) {
                let row = e.target.closest('.color-image-row');
                row.remove();
            }
        });
    </script>
