            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    ...
                    <div class="ms-auto pageheader-btn">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0);">Sizes Table</a></li>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header border-bottom">
                                ...
                                <a href="{{ route('size.add') }}" class="btn btn-primary ms-auto d-block">Add Size</a>
                            </div>
                            <div class="card-body">
                                @if(session('message'))
                                        ...
                                        <tbody>
                                            @foreach ($sizes as $size)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('size.edit', $size->id) }}" class="btn btn-sm btn-warning">Edit</a>
                                                        <form action="{{ route('size.delete', $size->id) }}" method="GET" style="display: inline;">
                                                            @csrf
                                                            @method('DELETE')
